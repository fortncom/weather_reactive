package ru.job4j.weather.weatherreactive.controller;
...
import ru.job4j.weather.weatherreactive.model.Weather;
import ru.job4j.weather.weatherreactive.service.WeatherService;
...
public class WeatherControl {
    ...
    public Flux<Weather> getGreatThen(@PathVariable Integer temperature) {
        return weathers.getGrether(temperature);
    }
}